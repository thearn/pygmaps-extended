pygmaps is a Python wrapper for Google Maps JavaScript API V3. pygmaps provides functions to generate HTML file which shows your GPS data on Google map.

Originally cloned from [Yifei Jiang](https://code.google.com/p/pygmaps/).
